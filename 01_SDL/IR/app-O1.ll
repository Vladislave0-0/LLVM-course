...
27:                                               ; preds = %42
  %28 = add nsw i32 %23, 1
  %29 = icmp eq i32 %28, 2
  br i1 %29, label %46, label %21, !llvm.loop !12
...
42:                                               ; preds = %35, %30
  ...
  %44 = add nsw i32 %32, 1
  %45 = icmp eq i32 %44, 2
  br i1 %45, label %27, label %30, !llvm.loop !13
...
46:                                               ; preds = %27
  ...
  br i1 %57, label %14, label %18, !llvm.loop !14
...
60:                                               ; preds = %63
  ...
  br i1 %62, label %67, label %58, !llvm.loop !15

63:                                               ; preds = %58, %63
  %64 = phi i32 [ 0, %58 ], [ %65, %63 ]
  tail call void @simPutPixel(i32 noundef %64, i32 noundef %59, i32 noundef -1) #5
  %65 = add nuw nsw i32 %64, 1
  %66 = icmp eq i32 %65, 512
  br i1 %66, label %60, label %63, !llvm.loop !16
...
74:                                               ; preds = %77
  ...
  br i1 %76, label %81, label %71, !llvm.loop !17

77:                                               ; preds = %77, %71
  %78 = phi i32 [ 0, %71 ], [ %79, %77 ]
  tail call void @simPutPixel(i32 noundef %73, i32 noundef %78, i32 noundef 6908265) #5
  %79 = add nuw nsw i32 %78, 1
  %80 = icmp eq i32 %79, 512
  br i1 %80, label %74, label %77, !llvm.loop !18
...
84:                                               ; preds = %87
  ...
  br i1 %86, label %91, label %81, !llvm.loop !19

87:                                               ; preds = %87, %81
  %88 = phi i32 [ 0, %81 ], [ %89, %87 ]
  tail call void @simPutPixel(i32 noundef %88, i32 noundef %83, i32 noundef 6908265) #5
  %89 = add nuw nsw i32 %88, 1
  %90 = icmp eq i32 %89, 512
  br i1 %90, label %84, label %87, !llvm.loop !20

91:                                               ; preds = %84
  tail call void (...) @simFlush() #5
  %92 = add nuw nsw i32 %9, 1
  %93 = icmp eq i32 %92, 10000
  br i1 %93, label %10, label %8, !llvm.loop !21

94:                                               ; preds = %116
  %95 = add nuw nsw i64 %68, 1
  %96 = icmp eq i64 %95, 16
  br i1 %96, label %71, label %67, !llvm.loop !22
...
108:                                              ; preds = %111
  ...
  br i1 %110, label %116, label %105, !llvm.loop !23

111:                                              ; preds = %111, %105
  %112 = phi i32 [ 0, %105 ], [ %114, %111 ]
  %113 = add nuw nsw i32 %112, %104
  tail call void @simPutPixel(i32 noundef %113, i32 noundef %107, i32 noundef -2139062017) #5
  %114 = add nuw nsw i32 %112, 1
  %115 = icmp eq i32 %114, 32
  br i1 %115, label %108, label %111, !llvm.loop !24

116:                                              ; preds = %108, %97
  %117 = add nuw nsw i64 %98, 1
  %118 = icmp eq i64 %117, 16
  br i1 %118, label %94, label %97, !llvm.loop !25
}
