...
ISA(
    ...
    { builder.CreateStore(GEN_IMM(I.r2imm), GEP2_64(I.rd)); })

ISA(
    0x4, BR_COND, SKIP_3ARGS, READ_REG_3LABEL, WRITE_REG_3LABEL,
    {
      if (cpu->reg_file[rd]) {
        cpu->next_pc = r2imm;
      } else {
...
ISA(
    0x5, BRANCH, SKIP_1ARG, READ_2LABEL, WRITE_2LABEL, { cpu->next_pc = r2imm; },
    {
