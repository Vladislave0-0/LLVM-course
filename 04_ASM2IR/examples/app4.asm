...
draw_vertical_body
    SHL x17 x16 4    ; x17 = line_x = x * 16
    MOVi x18 0       ; y координата
...
draw_vertical_inner_body
    MOVi x19 6908265 ; Цвет сетки: 0x696969
    SCREEN_PUT_PIXEL x17 x18 x19
    ADDi x18 x18 1
    BRANCH draw_vertical_inner_cond
...
draw_horizontal_body
    SHL x17 x16 4    ; x17 = line_y = y * 16
    MOVi x18 0       ; x координата
